...
async def run_trigger():
    print("=== Triggering Session Bindings programmatically ===")
    ...
    for summary in active_summaries:
        try:
            ...
            if unresolved_calls:
                ...
                # Check if this matches one of our test emails
                target_emails = [
                ...
                if emp_name in target_emails:
                    print(f"\nProcessing active session {sess.id} for {emp_name}:")
